...
/**
 * Server ishga tushganda faqat super-admin akkauntini yaratadi.
 * Qolgan mock ma'lumotlar (units, categories, stores, products va h.k.) —
 * `npm run seed` buyrug'i bilan alohida ishga tushadi.
 */
@Injectable()
